...
while True:
    ...
    if sml_ende in buffer:
        ...
        if crc_check(buffer[idx + 5:idx + 7],sml_data) == True:   
            ...
            mein_zaehler = Zaehler(decode_manufacturer(suchen(sml_data.hex(),vendor_obis.start,vendor_obis.offset,vendor_obis.laenge)),parse_device_id(suchen(sml_data.hex(),sn_obis.start,sn_obis.offset,sn_obis .laenge)))
